...
class PackageAdmin(admin.ModelAdmin):
    list_display = ("id", "title", "group_package", "gym_name", "gender", "price", "duration", "commission_rate", "order_homepage", "dedicated", "purchases_count")
    search_fields = ("title", "description", "group_package__title", "group_package__gym__name")
    list_filter = ("gender", "group_package__gym", "duration", "dedicated")
